...
function connect() {
    ...
    ws.onopen = function() {
        setConnected(true);
        document.getElementById('msg').innerHTML = '<span style="color:green; font-weight: bolder; margin-top: 5px;">Connected</span>';
    };
    ...
    ws.onclose = function(event) {
        setConnected(false);
        document.getElementById('msg').innerHTML = '<span style="color:red; font-weight: bolder; margin-top: 5px;">Disconnected</span>';
    };
}
